...
from .views import PostListView, PostDetailView, RegisterView, ProfileView, ToggleLikeView, AboutUs, ExitView, AddToBasketView, UpdateBasketView, PostBasket
...
urlpatterns = [
    ...
    path('basket/', PostBasket.as_view(), name='basket'),
]